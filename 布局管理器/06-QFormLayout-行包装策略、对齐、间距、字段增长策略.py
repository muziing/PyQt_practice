...
class Window(QWidget):
    ...
    def setup_ui(self):
        ...
        # -------字段增长策略--------
        layout.setFieldGrowthPolicy(QFormLayout.FieldsStayAtSizeHint)  # 这些领域永远不会超过其有效大小的提示
        layout.setFieldGrowthPolicy(QFormLayout.ExpandingFieldsGrow)  # 水平大小策略为Expanding或MinimumExpanding的字符将增长
